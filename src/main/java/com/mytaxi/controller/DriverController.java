...
public class DriverController
{
    ...
    @GetMapping("search")
    public List<DriverDTO> search(@RequestParam(value="seatCount",required=false) String seatCount,
    		@RequestParam(value="convertiable",required=false) Boolean convertiable,
    		@RequestParam(value="engineType",required=false) EngineType engineType,
    		@RequestParam(value="licensePlate",required=false) String licensePlate)
    		throws ConstraintsViolationException, EntityNotFoundException
    {
        return DriverMapper.makeDriverDTOList(driverService.search(seatCount, convertiable, engineType, licensePlate));
    }
}
