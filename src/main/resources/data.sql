...
-- INSERT CARS 
 insert into car (id, convertible, date_created, deleted, engine_type, license_plate, rating, seat_count) values (1, true,  now(), false, 'GAS', '1-1-1'
 , '1', '1');
  insert into car (id, convertible, date_created, deleted, engine_type, license_plate, rating, seat_count) values (2, true,  now(), false, 'GAS', '2-2-2'
 , '2', '2');
 insert into car (id, convertible, date_created, deleted, engine_type, license_plate, rating, seat_count) values (3, true,  now(), false, 'GAS', '3-3-3'
 , '3', '3');
